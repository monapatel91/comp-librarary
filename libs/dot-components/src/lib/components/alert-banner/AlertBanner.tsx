...
export const DotAlertBanner = ({
  ...
  const AlertBannerIcon = (iconId:string) => { return <DotIcon iconId={iconId} />};
  const AlertBannerIconMapping = {error: AlertBannerIcon('error-solid'), info: AlertBannerIcon('info-solid'), success: AlertBannerIcon('check-solid'), warning: AlertBannerIcon('warning-solid') };
